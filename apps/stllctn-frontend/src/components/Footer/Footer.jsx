  ...
  return (
    <>
      <div className="footer">
        <div
          className={"" + (props.wide ? "container-wide" : "container-regular")}
        >
          <Divider mb="4" />
          <div className="footer-row">
            <div className="copyright-info">© {getYear()} Stellection</div>
            <div className="github-info-column">
              <div className="icon-text-wrapper">
                <Tooltip
                  text={gitInfo.commit.message}
                  type="dark"
                  placement="top"
                  leaveDelay={50}
                >
